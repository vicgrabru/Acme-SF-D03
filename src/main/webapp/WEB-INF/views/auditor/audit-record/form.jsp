...
<acme:form>
	<acme:input-textbox code="auditor.audit-record.form.label.code" path="code" readonly="${readOnlyCode}"/>
	...
	<acme:input-url readonly="true" code="auditor.audit-record.form.label.link" path="link"/>
