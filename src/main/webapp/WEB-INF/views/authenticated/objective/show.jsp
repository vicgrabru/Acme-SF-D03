...
<acme:list>
	...
	<acme:list-column code="authenticated.objective.list.label.instantiation-moment" path="instantiationMoment" width="10%"/>
	...
	<acme:list-column code="authenticated.objective.list.label.isCritical" path="isCritical" width="10%"/>
	<acme:list-column code="authenticated.objective.list.label.startDateDuration" path="startDateDuration" width="10%"/>
	<acme:list-column code="authenticated.objective.list.label.endDateDuration" path="endDateDuration" width="10%"/>
