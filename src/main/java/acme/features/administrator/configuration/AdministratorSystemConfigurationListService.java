...
@Service
public class AdministratorSystemConfigurationListService extends AbstractService<Administrator, SystemConfiguration> {
	...
	@Override
	public void load() {
		Collection<SystemConfiguration> objects;

		objects = this.repository.findSystemConfiguration();
